...
from rival_vehicle_util import RivalVehicleController, register_handlers
...
class KeyboardControl(object):
    ...
    def __init__(self, world, start_in_autopilot):
        ...
        self._rival_vehicle_controller = RivalVehicleController(world.world, world.player)
        register_handlers(self._rival_vehicle_controller)
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if self._is_quit_shortcut(event.key):
                    ...
                    world.hud.notification("Key E pressed.")
                    # try:
                    #     with open('./data.json') as f:
                    #         data = json.load(f)
                    #         self._rival_vehicle_controller.distribute(data)
